...
const VARIANT_CLASSES: Record<Variant, string> = {
  ...
  secondary: "bg-[var(--dw-input)] text-zinc-700 hover:bg-[var(--dw-hover)] dark:text-zinc-200",
  danger: "bg-red-600 text-white hover:bg-red-700",
  ghost: "text-zinc-500 hover:text-zinc-900 hover:bg-[var(--dw-hover)] dark:text-zinc-400 dark:hover:text-white",
};
